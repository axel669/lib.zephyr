<script>
    ...
    using an input with type="number"
    ...
    ```svelte
    <Input.Number bind:value />
    <Input.Number bind:value color="primary" />
    <Input.Number bind:value label="Wat" hint="Blep"/>
    <Input.Number bind:value bind:tvalue transform={parseInt} />
    <Input.Number bind:value transform={parseInt} bind:valid validate={value => value > 0} />
    ```
    */
